      ...
      <button
        className={cn(
          'inline-flex items-center justify-center rounded-md font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none transform hover:scale-[1.02]',
          {
            ...
            'border-2 border-primary-200 bg-gradient-to-br from-white to-gray-50 hover:from-gray-50 hover:to-gray-100 focus-visible:ring-primary-400 text-primary-700 shadow-sm hover:shadow': variant === 'outline',
            'bg-transparent hover:bg-primary-50 focus-visible:ring-primary-400 text-primary-700': variant === 'ghost',
